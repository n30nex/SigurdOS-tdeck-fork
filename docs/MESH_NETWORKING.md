...
| [`RF_INTEROP_TEST_PLAN.md`](RF_INTEROP_TEST_PLAN.md) | Minimal local-node RF interop validation for repeaters, rooms, DMs, channel messages, packet logs, and trace/path |
